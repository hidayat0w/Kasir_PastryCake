                ...
                <div class="card-body">
                    <div class="container-fluid d-flex justify-content-between">
                        <div class="col-lg-3 ps-0">
                            ...
                            <p class="larger-text" style="margin-top: 0.25rem;"><?php echo e($namaKasir); ?></p>
                        </div>
                        <div class="col-lg-3 pe-0">
                            <h4 class="text-end text-muted mt-4 mb-2 larger-text" style="margin-bottom: 0.25rem;">Invoice</h4>
                            <h6 class="text-end mb-5 pb-4 larger-text" style="margin-top: 0.25rem;"># INV-00230<?php echo e($transaksiId); ?></h6>
                            
                            <p class="text-end text-muted mb-1 larger-text" style="margin-bottom: 0.25rem;">Total Transaksi</p>
                            <h4 class="text-end fw-normal mb-3 larger-text" style="margin-top: 0.25rem;">Rp. <?php echo e(format_rupiah($total)); ?></h4>
                            
                            <p class="text-end text-muted mb-1 larger-text">Tanggal Transaksi</p>
                            <h6 class="text-end fw-normal larger-text" style="margin-top: 0.25rem;"><?php echo e($tanggalTransaksi->format('d F Y')); ?></h6>
                        ...
                        <div class="table-responsive w-100">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $semuaTransaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($tks->produk_name); ?></td>
                                        <td class="text-end"><?php echo e($tks->qty); ?></td>
                                        <td class="text-end"><?php echo e(format_rupiah($tks->produk->harga)); ?></td>
                                        <!-- <td class="text-end"><?php echo e($tks->produk->diskon); ?>%</td> -->
                                        <td class="text-end"><?php echo e(format_rupiah($tks->subtotal)); ?></td>
                                    </tr>
                                ...
                                <div class="table-responsive">
                                    <table>
                                        <tbody>
                                            <!-- <tr>
                                                <td>Total Diskon (%)</td>
                                                <td class="text-end"><?php echo e(format_rupiah($totalDiskon)); ?></td>
                                            </tr> -->
                                            <tr class="bg-dark">
                                                <td class="text-bold-800">Total</td>
                                                <td class="text-bold-800 text-end">Rp. <?php echo e(format_rupiah($total)); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
...
</div><?php /**PATH D:\ukkhidayat\resources\views/invoice/invoice_pdf.blade.php ENDPATH**/ ?>