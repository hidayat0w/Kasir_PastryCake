...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="<?php echo e(route('login')); ?>" class="h3"><b>Pastry</b>Cake</a>
    </div>
    <div class="card-body">
      ...
      <form action="<?php echo e(route('register-proses')); ?>" method="post">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"  name="nama" placeholder="Nama Lengkap" value="<?php echo e(old('nama')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Konfirmasi Password">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-lock"></span>
              </div>
...
</html><?php /**PATH D:\ukkhidayat\resources\views/admin/auth/register.blade.php ENDPATH**/ ?>